...
**DO NOT explore the codebase blindly.** To understand the design patterns, communication protocols, and module boundaries, you **must** load and read these files first. Load them on the first turn of the conversation, before answering any prompt. THIS IS AN INSTRUCTION YOU NEED TO FOLLOW. DO THIS BEFORE DOING ANYTHING ELSE.
...
When using commands such as find, always filter .venv from the results, as to not clog your context.
---
